...
L2 = 22             # [mm] distance from lens to object
...
plt.plot(zz1, yy, 'b--', alpha=0.25, label="Lens")
plt.plot(zz2, yy, 'b--', alpha=0.25)
plt.plot(zz3, yy, 'b--', alpha=0.25)
...
# plot the rays
plt.figure(5)
plt.plot(pz, py, color='m')
plt.plot(pz2, py2, color='m')
plt.plot(pz3, py3, color='m')
plt.plot(zz1, yy, 'b--', alpha=0.25)
plt.plot(zz2, yy, 'b--', alpha=0.25)
plt.plot(zz3, yy, 'b--', alpha=0.25)
